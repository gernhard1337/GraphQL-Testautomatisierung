...
\begin{document}
  ...
  % Einleitung
  \include{content/einleitung/Abstract}
  \include{content/einleitung/Einleitung}

  % Hauptteil

  \include{content/hauptteil/theorie/theorie}
  \include{content/hauptteil/theorie/Graphentheorie}
  \include{content/hauptteil/theorie/Webapi}
  \include{content/hauptteil/theorie/Graphql}
  \include{content/hauptteil/theorie/graphentheorie-graphql}
  \include{content/hauptteil/theorie/Testen}
  \include{content/hauptteil/theorie/Graphüberdeckung}
  \include{content/hauptteil/theorie/graphabdeckgraphql}

  \include{content/hauptteil/relatedWork/relatedWork}
  \include{content/hauptteil/praxis/Testentwurf}

  \include{content/hauptteil/praxis/praxis}
  \include{content/hauptteil/praxis/auswertung}

  %Schluss
  \include{content/schluss/futureWork}
  \include{content/schluss/fazit}
